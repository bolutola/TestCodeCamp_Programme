...
public class HomePage {
    ...
    private By loginButton = By.xpath("/html/body/div[1]/div/section/div[3]/nav/div[2]/div/div/div[4]/a");
    private By categoryBarElement = By.className("ef511_2c5_i");
    private By subcategory = By.xpath("//*[@id=\"app-content-wrapper\"]/div[3]/div[1]/div/div/div[2]/div/div/div[1]/a[6]");
